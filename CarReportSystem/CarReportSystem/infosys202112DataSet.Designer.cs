...
namespace CarReportSystem.infosys202112DataSetTableAdapters {
...
SELECT Id, CreatedDate, Author, Maker, CarName, Report, Picture FROM CarReport WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CarReportSystem.Properties.Settings.Default.infosys202112ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT                      Id, CreatedDate, Author, Maker, CarName, Report, Pict" +
                "ure\r\nFROM                         CarReport\r\nWHERE                       (Create" +
                "dDate = @date)";
        ...
        public virtual int Fill(infosys202112DataSet.CarReportDataTable dataTable) {
        ...
        public virtual infosys202112DataSet.CarReportDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            infosys202112DataSet.CarReportDataTable dataTable = new infosys202112DataSet.CarReportDataTable();
        ...
        public virtual int FillByDate(infosys202112DataSet.CarReportDataTable dataTable, string date) {
        ...
        public virtual infosys202112DataSet.CarReportDataTable GetDataBy(string date) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((date == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(infosys202112DataSet.CarReportDataTable dataTable) {
